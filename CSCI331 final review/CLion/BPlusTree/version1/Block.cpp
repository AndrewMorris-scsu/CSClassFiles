//Block.cpp
//compile g++ -c Block.cpp -std=c++11
#include "Block.h"
int Block::order=0;
...
Block::Block (int _RBN){//testing function
		RBN= _RBN;
		isLeaf=false;
		isRoot=false;
		numChildren=0;
...
Block::Block(bool _isRoot, bool _isLeaf, int _RBN){//for creating a new node
		isLeaf=_isLeaf;
		isRoot=_isRoot;
		RBN=_RBN;
		elementsUsed=0;
...
/**
 * @brief accessor method for childrenList. Simulates childrenList.at(x)
 */
...
void Block::writeBlock(ostream& out){//1 99, 
