...
public class UserInterface {
  ...
  public void help() {
    ...
    System.out.println(SHOW_MEMBERS_BOOKS +" to print all books checked out by a member");
  ...
  public void issueBooks() {
      //System.out.println("Please provide member ID... ");
	  ...
	  memberID = getToken("Please provide member ID... ");
      
      //Call search on library
      aMember = library.searchForMember(memberID);
      if (aMember == null) {
    	  System.out.println("Did NOT find Member with the ID :"+memberID);   
    	  return;
      } else {
    	  System.out.println(aMember.getName() +" Found :");
      }
      ...
      while (moreBooks) {
    	 ...
    	 bookID = getToken("Please provide book ID to issue to "+ aMember.getName() +":");
    	 
         //Call search on library
         aBook = library.searchForBook(bookID);
         if (aBook == null) {
       	  System.out.println("Did NOT find Book with the ID :"+bookID);   
       	  
         } else {
       	  System.out.println(aBook.getTitle() +" Found");
         
       	  if (library.issueBook(bookID, memberID)) {
            System.out.println("BookID ["+bookID+"] was successfully issued");
          }
          else {
            System.out.println("Could not issue BookID:["+bookID+"] book successfully..");
          }
         }
         
         if (getToken("Would you like to add more books for the member?"
         		+ "'y' for YES, 'n' for NO:").equals("n")) {
        	 moreBooks = false;
         }
  ...
  public void showMembersBooks() {
      ...
      if (aMember == null) {
    	  System.out.println("Did NOT find Member with the ID :"+memberID); //IMPLEMENT THIS IF-ELSE in library class..    
    	  return;
      } else {
    	  System.out.println(aMember.getName() +" Found :");
      }
      aMember.printBooksBorrowed();
  }
    ...
    while ((command = getCommand()) != EXIT) {
      switch (command) {
        ...
        case SHOW_BOOKS:	showBooks();
                                break; 
        case SHOW_MEMBERS_BOOKS: showMembersBooks();
        						break;
        case HELP:              help();
                                break;
      }
